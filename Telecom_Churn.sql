...
-- After checking the null values, there are no null values exist in the data
-- If the null values are existed in the data then remove null and insert the new data into Prod table
